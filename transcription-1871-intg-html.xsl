...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/">
		<html>
			...
			<head>
				<meta charset="UTF-8"/>
				<link rel="stylesheet" type="text/css" href="http://livingstoneonline.github.io/LEAP-XSLT/style-1871-intg-html.css"/><!-- http://livingstoneonline.github.io/LEAP-XSLT/ -->
				<title>
	...
	<xsl:template match="TEI">
        ...
        <xsl:value-of select="//teiHeader//title[2]"/>
			...
			<div class="TEI">
				...
				<span class="authority"><strong>Repositories:</strong><xsl:text> David Livingstone Centre; National Library of Scotland; Bodleian Library: Weston Library</xsl:text></span><br/>
