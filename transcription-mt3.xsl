	...
	<xsl:template match="/">
		<html>
			...
			<head>
				...
				<link rel="stylesheet" type="text/css" href="http://livingstoneonline.github.io/LEAP-XSLT/css/style-mt-html.css"/><!-- http://livingstoneonline.github.io/LEAP-XSLT/ -->
				<link rel="stylesheet" type="text/css" href="http://livingstoneonline.github.io/LEAP-XSLT/css/style-mt3-html.css"/><!-- http://livingstoneonline.github.io/LEAP-XSLT/ -->
				<title>
					<xsl:value-of select="//teiHeader//title[1]"/>
				</title>
				<!--<link type="text/css" rel="stylesheet" href="http://jamescummings.github.io/LEAP/style.css"/>-->
			</head>
			<body class="style-mt-html style-mt3-html">
