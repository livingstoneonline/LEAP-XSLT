...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/">
		<html>
			...
			<head>
				...
				<link rel="stylesheet" type="text/css" href="http://livingstoneonline.github.io/LEAP-XSLT/css/style-Bambarre-annotations.css"/>
				<!--<link rel="stylesheet" type="text/css" href="style-Bambarre-annotations.css"/>-->
				<title>
					<xsl:value-of select="//teiHeader//title[1]"/>
				</title>
				<!--<link type="text/css" rel="stylesheet" href="http://jamescummings.github.io/LEAP/style.css"/>-->
			</head>
			<body class="style-Bambarre-annotations">
	...
	<xsl:template match="TEI">
		<div class="transcription style-Bambarre-annotations">
        ...
        <xsl:value-of select="//teiHeader//title[2]"/>
			...
			<div class="TEI">
				<div class="item-details">
					...
					<span class="author">Adrian S. Wisnicki, with Debbie Harrison</span><br/>
					...
					<span class="authority"><strong>Digital edition and date(s):</strong><xsl:text> </xsl:text> <a href="http://livingstoneonline.org/" target="_blank"><xsl:value-of select="//teiHeader//authority"/></a>,</span><xsl:text> </xsl:text><span class="pub-date">2010, 2011, 2017</span><br/>
					<span class="authority"><strong>Publisher for current edition:</strong><xsl:text> </xsl:text><xsl:value-of select="//teiHeader//publicationStmt/publisher"/>,</span><xsl:text> </xsl:text><span class="pub-date"><xsl:value-of select="//teiHeader//publicationStmt/pubPlace"/></span><br/>
...
<xsl:template match="idno[@type='LEAP-ID']">
	...
	<xsl:template match="note[@target]" priority="10">
